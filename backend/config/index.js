...
config.cors = {}
config.cors.origin = process.env.CORS_ORIGIN || ['http://localhost:8080']

// strategy
config.auth = {}
config.auth.google = {}
config.auth.google.clientId = process.env.AUTH_GOOGLE_CLIENT_ID
config.auth.google.clientSecret = process.env.AUTH_GOOGLE_CLIENT_SECRET
config.auth.facebook = {}
config.auth.facebook.clientId = process.env.AUTH_FACEBOOK_CLIENT_ID
config.auth.facebook.clientSecret = process.env.AUTH_FACEBOOK_CLIENT_SECRET
