        ...
        <div className='w-[calc(100vw - 100%)] flex justify-center items-center flex-col'>
            ...
            <div className='flex flex-col'>
                <div className='flex gap-[7.089337175792507vw] mt-[6.628242074927954vw] xsm:flex-col sm:flex-col xsm:w-[80%] xsm:m-auto sm:w-[80%] sm:m-auto'>
                    ...
                    <div>
                        <div className='w-[35.04322766570605vw] xsm:w-full sm:w-full flex flex-wrap gap-[1.037463976945245vw]'>
                            {likes.map((like) => {
                                return (
                                    <Button whileHover={{ background: "#0252ED", color: "white" }} width='106px' height="38px" text={like} style={{ border: "1px solid #0252ED", borderRadius: "10px", fontSize: "14px", lineHeight: "22.8px", color: "#000000", background: "rgba(0,0,0,0)" }}></Button>
                                )
                            })}
                        </div>
                ...
                <div className='xsm:w-[80%] xsm:m-auto sm:w-[80%] sm:m-auto flex justify-end'>
                    <Link to="/dashboard">
                        <Button whileHover={{ background: "rgba(0,0,0,0)", color: "#473a3a" }} width='231px' height="58px" text={"Complete"} style={{ alignSelf: "flex-end", margin: "80px 0", border: "3px solid #0252ED", borderRadius: "20px", fontSize: "14px", lineHeight: "22.8px", color: "#fff", background: "#0252ED" }}></Button>
                    </Link>
                </div>
            </div>
        </div>
