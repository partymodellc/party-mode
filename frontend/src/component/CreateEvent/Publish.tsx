        ...
        <>
                ...
                <div
                    ...
                    <div className="flex gap-[20px]">
                        ...
                        <img
                            ...
                            src={`http://localhost:8000/Storage/${singleEvent?.image}`}
                            alt=""
                        />
                    </div>
                </div>
            ...
            <div className="w-[56.829971181556196vw] xsm:w-[90%] sm:w-[50%] m-auto mt-[66px]">
                ...
                <div
                    ...
                    <div
                        className="w-[20.518731988472624vw] h-full bg-[#D9D9D9] flex justify-center items-center xsm:w-full sm:w-full">
                        <img
