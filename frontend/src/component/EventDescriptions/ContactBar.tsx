...
export default function ContactBar({heading,text}: Props) {
  return (
    <motion.div initial={{color:"#473a3a"}} whileHover={{scale:1.01}} className='xsm:min-w-[80vw] shadow-md flex justify-between items-center px-[23px] my-[6px] w-[71.296%] min-w-[260px] h-[74px] bg-[#9fb9f4] m-auto'>
