...
export default function OrderRow({data}: any) {
    ...
    return (
        <div className="divide-y-2">
            ...
            >
                <div
                    className="flex justify-between items-center mx-[2%] xsm:flex-col sm:flex-col xsm:gap-[10px] sm:gap-[10px]">
                    <div
                        className="flex gap-[3.4582132564841497vw] items-center xsm:flex-col sm:flex-col xsm:items-start">
