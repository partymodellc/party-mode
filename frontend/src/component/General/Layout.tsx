                        ...
                        {drawer.map((item) => {
                            return (
                                <NavLink to={item.route} end>
                                    <div
                                        style={location.pathname.includes(item.route) ? {background: "#ffffff"} : {background: "#FB4A04"}}
                                        key={item.id} className='w-[57px] h-[61px] flex justify-center items-center'>
                                        <img
                                            src={location.pathname.includes(item.route) ? item.iconOrange : item.iconWhite}
                                            alt=""/>
                                    </div>
                                </NavLink>
                            )
