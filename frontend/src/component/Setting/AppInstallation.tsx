...
export default function AppInstallation({ }: Props) {
    return (
        <div className='w-[78.04034582132564vw] flex flex-col justify-center items-center'>
            ...
            <Button whileHover={{background:"#fff",color:"#0252ED",border:"1px solid #0252ED"}} width="255px" height='47px' text="Browse Apps" style={{background:"#0252ED", borderRadius: "0px", fontSize: "20px", alignSelf: "flex-end", marginTop: "150px" }} />
        </div>
    )
}