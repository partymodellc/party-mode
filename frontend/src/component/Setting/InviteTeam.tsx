    ...
    return (
        <>
            <Modal showModal={showModal} hideShowModalHandler={hideShowModalHandler}>
                <div className='w-[49.106628242074926vw] h-[473px] bg-white'>
                    <div className='w-[38.38616714697406vw] m-auto'>
                        ...
                        <Button whileHover={{background:"#fff",color:"#eece93",border:"1px solid #eece93"}} width='254px' height='61px' text="Send Invite" style={{background:"#eece93", borderRadius: "0px",marginTop:"88px" }} />
                    </div>
                </div>
            </Modal>
            <div className='w-full xsm:w-[80%] flex flex-col justify-center items-center xsm:m-auto sm:m-auto'>
                ...
                <Button whileHover={{background:"#fff",color:"#eece93",border:"1px solid #eece93"}}  onClick={() => ShowModalhandler()} width="158px" height='47px' text="Invite Users" style={{background:"#eece93", borderRadius: "0px", fontSize: "20px", marginTop: "22px" }} />
            </div>
        </>
    )
}