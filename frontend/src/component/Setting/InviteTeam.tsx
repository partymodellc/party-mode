    ...
    return (
        <>
            <Modal showModal={showModal} hideShowModalHandler={hideShowModalHandler}>
                <div className='w-[49.106628242074926vw] h-[473px] bg-white'>
                    <div className='w-[38.38616714697406vw] m-auto'>
                        ...
                        <Button whileHover={{background:"#fff",color:"#0252ED",border:"1px solid #0252ED"}} width='254px' height='61px' text="Send Invite" style={{background:"#0252ED", borderRadius: "0px",marginTop:"88px" }} />
                    </div>
                </div>
            </Modal>
            <div className='w-full xsm:w-[80%] flex flex-col justify-center items-center xsm:m-auto sm:m-auto'>
                ...
                <Button whileHover={{background:"#fff",color:"#0252ED",border:"1px solid #0252ED"}}  onClick={() => ShowModalhandler()} width="158px" height='47px' text="Invite Users" style={{background:"#0252ED", borderRadius: "0px", fontSize: "20px", marginTop: "22px" }} />
            </div>
        </>
    )
}