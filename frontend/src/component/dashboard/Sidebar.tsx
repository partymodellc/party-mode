...
export default function Sidebar({children}: Props) {
    ...
    return (
        <div>
            ...
            <div className='flex'>
                <div
                    className='w-[78px] xsm:w-[57px] sm:w-[57px] bg-[#0252ED] h-[1015px] flex flex-col justify-between items-end pt-[65px] '
                >
                            ...
                            return (
                                <NavLink key={item.name} to={item.route} end>
                                    <div
                                        ...
                                        style={location.pathname == item.route ? {background: "#ffffff"} : {background: "#0252ED"}}
                                    >
                                        <img
