        ...
        <>
            ...
            <footer
                className={showFooterHeaders ? "flex flex-col justify-between w-[100%] bg-[#0252ED] text-[#ffffff] xsm:h-auto sm:h-auto h-auto" : "flex flex-col justify-between w-[100%] bg-[#0252ED] text-[#ffffff] xsm:h-auto"}>
                {
                    showFooterHeaders &&
                    <motion.div
                        className='w-[90%] mb-[77px] m-auto flex justify-around mt-[55px] xsm:flex-col flex-wrap xsm:gap-[40px] sm:gap-[40px]'
                    >
                        <ul>
                            <h3
                        ...
                        <ul>
                            ...
                            <motion.li whileHover={{color: "#473a3a"}}>
                                <a
                                    href="https://www.instagram.com/reel/Ckt0HO0jwUt/?igshid=YmMyMTA2M2Y="
                                    target={"_blank"}
                                >Instagram</a>
                            </motion.li>
                            <motion.li whileHover={{color: "#473a3a"}}><a target={"_blank"}>LinkedIn</a></motion.li>
                            <motion.li whileHover={{color: "#473a3a"}}>
                                <a href="https://vm.tiktok.com/ZMFPkXUYS/" target={"_blank"}>TikTok</a>
                            </motion.li>
                            <motion.li whileHover={{color: "#473a3a"}}>
                                <a
                                    href="https://twitter.com/partymode_/status/1579279888879878147?s=12&t=-jK89kyXLwS-ennKAld_Sw"
                                    target={"_blank"}
                                >Twitter</a>
                            </motion.li>
                            {/*<motion.li whileHover={{color: "#473a3a"}}>*/}
