            ...
            <div className='relative top-[92px]'>
                <section className='contactusBackgroundImage relative top-0 h-[514px]'>
                    <div className='relative z-20 pt-[150px] ml-[14.178674351585014vw] xsm:ml-[5vw]'>
                        ...
                        <motion.input whileHover={{ scale: 1.03 }} className='border-[3] border-[#eece93] w-[20.634005763688762vw] min-w-[220px] h-[52px] indent-[3.861671469740634vw] !bg-[#fff]' placeholder='Search Help' style={{ backgroundImage: `url("../assets/contactSearch.png")`, backgroundRepeat: "no-repeat", backgroundPosition: "18px center" }}></motion.input>
                    </div>
                </section>
                ...
                <section>
                    <div className='flex justify-between items-center w-[86vw] m-auto mt-[59px] gap-[3.7463976945244957vw]'>
                        ...
                        <h2 className='text-[#eece93] font-[700] text-[clamp(18px,2.07492795389049vw,36px)] leading-[80px] md:leading-[40px] sm:leading-[30px] xsm:leading-[30px] text-center'>Partymode Support Articles</h2>
                        <div className='min-w-[23.57348703170029vw] min-h-[1px] bg-[#cfcfcf]'></div>
                    </div>
                    ...
                    <div className='w-[86%] m-auto flex sm:flex-col xsm:flex-col mt-[119px] flex-col'>
                            ...
                            <div className='flex-1'>
                                ...
                                <div className='mt-[17px]'>
                                    <div className='flex items-start gap-[9px]'>
                                        ...
                                        <Link to="/help-sub">
                                            <motion.div whileHover={{color:"#eece93"}} className='font-[400] text-[clamp(14px,1.1527377521613833vw,20px)] leading-[52px] md:leading-[35px] xsm:leading-[30px] sm:leading-[30px] text-[#473a3a]'>Account Setup</motion.div>
                                        </Link>
                                    </div>
                                    <div className='flex items-start gap-[9px]'>
                                        <img className="pt-[2%]" src='darkCircle.png' alt='' />
                        ...
                        <div className='flex mt-[109px] sm:flex-col xsm:flex-col xsm:gap-[100px] sm:gap-[100px]'>
                            ...
                            <div className='flex-1'>
                                ...
                                <Button whileHover={{ background: "transparent", border: "3px solid #eece93", color: "#eece93" }} width='231px' height='58px' text="Contact us" style={{ background: "#eece93", borderRadius: "20px", marginTop: "5px" }} />
                            </div>
                        </div>
                    </div>
                </section>
