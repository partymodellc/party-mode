...
export default function CreateEvent() {
    ...
    return (
        <div>
            ...
            {/*            <motion.p whileHover={{color: "#FB4A04"}}*/}
            {/*                      className='text-[#473a3a] font-[700] text-[14px] leading-[23px] text-center'>{user?.email}</motion.p>*/}
            {/*        </li>*/}
            {/*    </ul>*/}
            {/*</nav>*/}
            {/*{showMobileNav &&*/}
            ...
            {/*        <li className='flex items-center gap-[8px]'>*/}
            {/*            <img className="w-10 h-10 rounded-full" src={user?.picture} alt={user?.username}/>*/}
            {/*            <p className='text-[#473a3a] font-[700] text-[14px] leading-[23px] text-center'>{user?.email}</p>*/}
            {/*        </li>*/}
            {/*    </ul>*/}
            {/*}*/}
