    ...
    return (
        <Layout>
            <div className='w-full pt-[65px] ml-[12.968299711815561vw] xsm:ml-[4vw] sm:ml-[6vw] flex gap-[7.089337175792507vw] xsm:flex-col sm:flex-col'>
                <div>
                    <h1 className='font-[700] text-[clamp(20px,2.07492795389049vw,36px)] leading-[58px] text-[#473a3a] ml-[10px]'>Welcome, <span className='text-[#FB4A04]'> {user.username} </span></h1>
