...
import EventsCards from "../component/Events/EventsCards";
...
import NewEventsCards from "../component/Events/NewEventCard";
...
export default function Dashboard({}: Props) {
    ...
    return (
        <>
            ...
            >
                <div
                    className="w-[41.84438040345821vw] xsm:w-[90vw] sm:w-[80vw] md:w-[60vw] h-[190px] bg-white px-[24px] flex flex-col justify-center">
                    ...
                    <div className="flex gap-[2.3054755043227666vw] xsm:flex-col sm:flex-col">
                        <input
                            className="w-[28.35734870317003vw] xsm:w-[60vw] sm:w-[60vw] h-[41px] border-[1px] border-[#231414D4]"></input>
                        <Button
            ...
            <div className="w-[calc(100vw - 100%)]">
                ...
                <div className="relative top-[92px]">
                    ...
                    <section className="dashboardBackground h-[778px] w-[100%] flex relative">
                        <div
                            className="flex flex-col justify-center absolute top-[332px] left-[65%] xsm:left-[10vw] sm:left-[50vw]">
