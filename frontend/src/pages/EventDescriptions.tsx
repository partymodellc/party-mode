...
import Crousal from "../component/EventDescriptions/Crousal";
import ContactBar from "../component/EventDescriptions/ContactBar";
            ...
            <div>
                ...
                >
                    ...
                    <div className="flex xsm:flex-col sm:flex-col w-[72%] xsm:w-[80%] sm:w-[76%] m-auto gap-[5.878vw]">
                        ...
                        <div
                            className="xsm:mt-[100px] sm:mt-[100px] xsm:mb-[100px] sm:mb-[100px] mt-[215px] flex-1 flex flex-col text-white">
                            ...
                            <p className="leading-[26.06px] mt-[19px] w-[38.81vw] min-w-[260px] xsm:min-w-[80vw] text-[clamp(12px,0.9221902017291066vw,16px)] font-[400]">
                                ...
                                {readmore
                                    ...
                                    : singleEvent.description?.length > 95
                                        ? singleEvent?.description?.substring(0, 95 - 1) + "..."
                                        : singleEvent?.description}
                            </p>
                            {!(singleEvent.description?.length > 95) ?
                                (
              ...
              <LazyImage alt="" src={"../video.png"} classes='shadow-md w-[71.23919308357348vw] xsm:min-w-[80vw]' />
                ...
                <section className="w-[90%] m-auto">
                    ...
                    <Crousal
                        ...
                        width={"29vw"}
                        settings={settings}
                        crousalData={singleEvent.images}
                ...
                <section className="mt-[52px] w-[100%] h-[705px] xsm:h-auto bg-[#fed4c3] mb-[79px] ">
                    ...
                    <div className="flex justify-center">
                        <iframe
                            src={`https://www.openstreetmap.org/export/embed.html?bbox=${singleEvent?.location?.longitude}%2C${singleEvent?.location?.latitude}%2C${singleEvent?.location?.longitude}%2C${singleEvent?.location?.latitude}&layer=mapnik`}
