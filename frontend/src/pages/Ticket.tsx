            ...
            <div className='w-[42.70893371757925vw]  xsm:w-[90%] sm:w-[80%] m-auto'>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <Link to={"/ticket-verified"}>
                        <Button whileHover={{ background: "#FB4A04", color: "white", scale: 1.03 }} width='232px' height='51px' text='Verify your email' style={{ marginBottom: "36px", background: "#fff", border: "1px solid #473a3a", borderRadius: "0px", color: "#473a3a", fontSize: "16xp", fontWeight: "400" }} />
                    </Link>
