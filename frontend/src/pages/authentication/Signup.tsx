            ...
            <div className='flex-1 bg-[#fff] ml-[-45px] xsm:ml-0 sm:ml-0 rounded-tl-[50px] rounded-bl-[50px]'>
                <div className='w-[52%] xsm:w-[70%] sm:w-[62%] m-auto'>
                    ...
                    <form className='mt-[30px]'>
                        <div
                            className='w-[27.608069164265128vw] flex xsm:flex-col sm:flex-col xsm:w-full sm:w-full gap-[1.2680115273775217vw]'>
                        ...
                        <div className='mt-[20px]'>
                            <label
                                className='font-[400] text-[clamp(12px,0.9221902017291066vw,16px)] leading-[26.06px] text-[#473a3a] mb-[12px]'
                            ...
                            <div className='flex mt-[19px] gap-[10px]'>
                                ...
                                <label className='text-[12px]'>I have read and agree with <span
                                    className='text-[#1977F3]'>terms of services</span> and <span
                                    className='text-[#1977F3]'>Privacy policy</span></label>
                            </div>
                        </div>
