    ...
    return (
        <div>
            ...
            <main className='w-[93.8328530259366vw] m-auto mt-[75px]'>
                <div className='w-full h-[105px] bg-[#0252ED0F] flex items-center rounded-[20px]'>
                    ...
                    <div className='w-[2.76657060518732vw] min-w-[28px] ml-[1.037463976945245vw]'>
                        <motion.img initial={{background: "transparent"}} whileHover={{scale: 1.03, background: "#fff"}}
                                    className="rounded-full" src='/ei_camera.svg'/>
                    </div>
                    <div className='w-[2.76657060518732vw] min-w-[28px] ml-[1.037463976945245vw]'>
                        <motion.img initial={{background: "transparent"}} whileHover={{scale: 1.03, background: "#fff"}}
                                    className="rounded-full" src='/ei_location.svg'/>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div
                        className='w-[53.94812680115274vw] xsm:w-full sm:w-full md:w-full px-[1.3%]  h-full rounded-[20px] bg-[#0252ED0F]'>
                        <div className='flex items-center  gap-[2.190201729106628vw] mt-[21px] xsm:flex-col'>
                            <motion.img whileHover={{scale: 1.03}} className='xsm:self-start shadow-md rounded-[20px]'
                                        src='/c21.png'/>
                            <div>
                                <h3 className='font-[700] text-[36px] leading-[58.64px] text-[#231414D4]'>Celebrity
                                    trends commnity</h3>
                                <div className='flex items-center gap-[12px]'>
                                    <div className='w-[54px]'>
                                        <motion.img whileHover={{scale: 1.03}} className='shadow-md rounded-full'
                                                    src='/Ellipse 66.png'/>
                                    </div>
                                    <h6 className='font-[700] text-[24px] leading-[39.09px] text-[#231414D4]'>Jonathan</h6>
                                    <span className='min-w-[3px] min-h-[35px] rounded-full bg-[#0252ED66]'></span>
                                    <p className='font-[700] text-[24px] leading-[39.09px] text-[#A3A3A3]'>2 mins</p>
                                </div>
                            </div>
                        </div>
                        <p className='font-[700] text-[24px] leading-[39.09px] text-[231414D4] mt-[78px] mb-[17px]'>Oh
                            My Celine dress in the event was awesome</p>
                        <img src='/c22.png'/>
                        <div className='flex gap-[2.5936599423631126vw] mt-[36px] mb-[39px] xsm:flex-col'>
                            <div className='w-[31.585014409221902vw] xsm:w-[100%]'>
                                <Search whileHover={{scale: 1.03}} text='Comment' style={{
                                    background: "transparent",
                                    textIndent: "19px",
                                    height: "65px",
                                    border: "1px solid #0252ED",
                            ...
                            <div className='flex gap-[0.5763688760806917vw]'>
                                <motion.img initial={{background: "transparent"}} whileHover={{scale: 1.03,}}
                                            className='rounded-full w-[3.4582132564841497vw] min-w-[30px]'
                                            src='/c27.svg'/>
                                <motion.img initial={{background: "transparent"}} whileHover={{scale: 1.03,}}
                                            className='rounded-full w-[3.4582132564841497vw] min-w-[30px]'
                                            src='/c28.svg'/>
                    ...
                    <div
                        className='w-[38.44380403458213vw] xsm:w-full sm:w-full md:w-full h-full rounded-[20px] bg-[#0252ED0F] divide-y-[5px] divide-[#0252ED3D]'>
                        ...
                        <div className='px-[1.38328530259366vw] pt-[46px]'>
                            <div className='flex flex-col gap-[46px]'>
                                <motion.div whileHover={{color: "#0252ED"}}
                                    ...
                                    <div className='flex flex-col justify-around'>
                                        <p className='!font-[400] text-[24px] leading-[39.09px] text-[231414D4]'>Public
                                            Community</p>
                                        <p className='!font-[700] text-[32px] leading-[52.13px] text-[231414D4]'>Musicals</p>
                                        <p className='!font-[400] text-[24px] leading-[39.09px] text-[231414D4]'>43k
                                            member</p>
                                    </div>
                                </motion.div>
                                <motion.div whileHover={{color: "#0252ED"}}
                                ...
                                <Button whileHover={{scale: 1.03, background: "#0252ED", color: "#fff"}} width='100%'
                                        height='94px' text='See All' style={{
                                    marginBottom: "65px",
                                    borderRadius: "52px",
                                    border: "2px solid #0252ED",
                                    color: "#0252ED",
                                    background: "transparent"
                                }}/>
                            </div>
                ...
                <div
                    ...
                    <div className='flex-1 h-full rounded-[20px] bg-[#0252ED0F] '>
                        <div
                            className='w-[38.454755043227664vw]  xsm:w-[80%] sm:w-[80%] md:w-[80%]  m-auto divide-y-[5px] divide-[#0252ED3D]'>
                            <div className='px-[1.38328530259366vw] py-[21px]'>
                            ...
                            <div className='px-[1.38328530259366vw] pt-[46px]'>
                                <div className='flex flex-col gap-[46px]'>
                                    ...
                                    <Button whileHover={{scale: 1.03, background: "#0252ED", color: "#fff"}}
                    ...
                    <div id='top-vibe'
                         className='flex-1 h-full rounded-[20px] bg-[#0252ED0F] divide-y-[5px] divide-[#0252ED3D]'>
                        <div
                            className='w-[38.454755043227664vw] xsm:w-[80%] sm:w-[80%] md:w-[80%] m-auto divide-y-[5px] divide-[#0252ED3D]'>
                            <div className='px-[1.38328530259366vw] py-[21px]'>
