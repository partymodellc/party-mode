...
import BarChart from '../../component/ReportAnalysis/BarChart'
import Sidebar from '../../component/dashboard/Sidebar'
import SingleBarChart from '../../component/ReportAnalysis/SingleBarChart';
import PieChart from '../../component/ReportAnalysis/PieChart';
// eslint-disable-next-line @typescript-eslint/ban-ts-comment.js
// @ts-ignore
import LineChart from '../../component/ReportAnalysis/LineChart';
            ...
            <div className='w-[85.76368876080691vw] ml-[6.974063400576369vw] xsm:ml-0 sm:ml-0 mt-[51px]'>
                <div className='w-full'>
                    <div className='flex gap-[39px] ml-[2.4207492795389047vw]'>
                        <label className='font-[400] text-[20px] leading-[32.58px] text-[#000000]'>Filter by
                            Date</label>
                        <select
                            className='w-[155px] h-[39px] rounded-[10px] border-[1px] border-[#CCCCCC] px-[34px] font-[400] text-[15px] leading-[24.43px] text-[#000000]'>
                    ...
                    <div
                        ...
                        <div
                            className='flex flex-col justify-center items-center w-[22.997118155619596vw] xsm:w-[80%] sm:w-[80%] h-[173px] rounded-[10px] bg-[#0252ED3D]'>
                        ...
                        <div
                            className='flex flex-col justify-center items-center w-[22.997118155619596vw] xsm:w-[80%] sm:w-[80%] h-[173px] rounded-[10px] bg-[#0252EDB8]'>
                        ...
                        <div
                            className='flex flex-col justify-center items-center w-[22.997118155619596vw] xsm:w-[80%] sm:w-[80%] h-[173px] rounded-[10px] bg-[#FBB60491]'>
                ...
                <div
                    className='w-full h-[578px] xsm:h-auto sm:h-auto flex gap-[18px] mt-[95px] xsm:flex-col sm:flex-col'>
                    ...
                    <div className='w-[48.5878962536023vw] xsm:w-[100%] sm:w-[80%] h-full  rounded-[20px]'>
                        ...
                        <div className='flex'>
                            <div className='h-[580px] flex xsm:hidden sm:hidden flex-col justify-between py-[5%]'>
                                <p className='font-[400] text-[14px] leading-[32.58px] text-[#000000]'>Excellent
                                    Vibe</p>
