                ...
                <div className='transition-all flex gap-[20px] mt-[29px] mb-[84px]'>
                    <NavLink end
                        ...
                        <motion.button initial={{opacity: 0, scale: 0.1,}}
                                       ...
                                       className='w-[69.03px] h-[36px] font-[700] text-[16px] leading-[26px] text-[#473a3a]'>Events
                        </motion.button>
                    </NavLink>
                    <NavLink end
                             className={({isActive}) => isActive ? "border-b-[1px] border-[#473a3a] py-[10px]" : "py-[10px]"}
                             to={"/event-dashboard/order"}>
                        <motion.button initial={{opacity: 0, scale: 0.1,}}
                                       whileInView={{opacity: 1, scale: 1}}
                                       viewport={{once: true}}
                                       transition={{
                                       ...
                                       className='w-[69.03px] h-[36px] font-[700] text-[16px] leading-[26px] text-[#473a3a]'>Orders
                        </motion.button>
                    </NavLink>
                </div>
                <div>
