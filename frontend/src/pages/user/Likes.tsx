            ...
            <div className='mt-[100px] ml-[14.351585014409222vw] xsm:ml-[12vw]'>
                ...
                <div className='flex gap-[20px] mt-[26px] xsm:flex-col-reverse'>
                    <div className='flex flex-col justify-center'>
                        <h2 className='font-[700] text-[clamp(14px,1.1527377521613833vw,20px)] leading-[33px] text-[#473a3a] w-[40.80691642651297vw] xsm:w-[80%]'>Hush
                            Haunt 2022 - Oct 13 Hush Haunted Attraction, Westland.</h2>
                        <p className='font-[400] text-[clamp(12px,0.9221902017291066vw,16px)] leading-[33px] text-[#FB4A0483]'>Thurs
