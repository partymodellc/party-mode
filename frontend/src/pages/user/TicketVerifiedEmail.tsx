        ...
        <div>
                ...
                <ul className='text-[#493c3c] xsm:hidden sm:hidden text-[clamp(12px,0.9221902017291066vw,16px)] font-[700] flex gap-[31px] mr-[7.37vw] items-center'>
                    <Link to="/dashboard">
                        <motion.li className='flex items-center gap-[8px]'>
                            <motion.p whileHover={{ color: "#0252ED" }} className='text-[#473a3a] font-[700] text-[14px] leading-[23px] text-center'>Back</motion.p>
                        </motion.li>
                    </Link>
                    <motion.li className='flex items-center gap-[8px]'>
                        <img src='./profile.png' alt='' />
                        <motion.p whileHover={{ color: "#0252ED" }} className='text-[#473a3a] font-[700] text-[14px] leading-[23px] text-center'>partymode@gmail.com</motion.p>
                    </motion.li>
                </ul>
            </nav>
            ...
            <div className='w-[42.70893371757925vw] xsm:w-[90%] sm:w-[80%] m-auto'>
                ...
                <div className='flex flex-col gap-[28px] items-center'>
                    <motion.div whileHover={{ scale: 1.03 }} className='shadow-sm flex gap-[20px] border-[1px] border-[#0252ED24] w-[41.95965417867435vw] xsm:w-[90%] sm:w-[80%] xsm:flex-col sm:flex-col'>
                    ...
                    <motion.div whileHover={{ scale: 1.03 }} className='shadow-sm flex gap-[20px] border-[1px] border-[#0252ED24] w-[41.95965417867435vw] xsm:flex-col sm:flex-col xsm:w-[90%] sm:w-[80%]'>
